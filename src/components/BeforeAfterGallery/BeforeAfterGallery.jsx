...
const imageData = {
  Pruning:  [
      ...
      { url: '/images/pruning/weeping-waterfall-japanese-maple_before-3.jpg', alt: 'Pruning before - garden needs trimming', caption: 'BEFORE - The garden is in need of trimming' },
      { url: '/images/pruning/weeping-waterfall-japanese-maple_after-1.jpg', alt: 'Pruning after - bushes trimmed', caption: 'AFTER - Bushes trimmed nicely' },
